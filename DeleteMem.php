...
<head>
	...
	<link rel="stylesheet" href="DeleteMem.css">
	<title>Admin-Delete Member Details</title>
</head>
<body>
	...
	<?php
		...
		if(isset($_POST['btnDelete']))
		{
			...
			else
			{
				...
				$sql = "DELETE FROM member WHERE registerNo='$regno' ";
	...
	<form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
		<table id="tblForm">
			...
			<tr>
				<td></td>
				<td>
					<input type="submit" class="inputbtn" name="btnDelete" value="Delete Member"></td>
				</td>
			</tr>
		</table>
	</form>
